...
public class ViewOrderItemDetailJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewOrderItemDetailJPanel(JPanel upc, OrderItem o) {
        initComponents();
        userProcessContainer = upc;
		
		txtProductName.setText(o.getProduct().getProdName());
		txtProductId.setText(String.valueOf(o.getProduct().getModelNumber()));
		txtQuantity.setText(String.valueOf(o.getQuantity()));
		txtSalesPrice.setText(String.valueOf(o.getProduct().getPrice()));
		txtPaidPrice.setText(String.valueOf(o.getSalesPrice()));
    }
