...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtAvailNum.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(txtAvailNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 160, 30));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String stringPrice = txtAvailNum.getText();
        if(stringPrice.isEmpty()==false){
            int price = Integer.parseInt(stringPrice);
            p.setPrice(price);
        }
		
		p.setAvailNum(Integer.parseInt(txtAvailNum.getText()));
