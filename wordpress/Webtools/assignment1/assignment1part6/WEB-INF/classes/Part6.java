...
public class Part6 extends HttpServlet  
{
    protected void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException
    {
		...
		html+="</head><body><form action='Part6' method='post'>";
		...
		html+="<tr> <td>Zip:</td><td><input id='txtZip' type='text' name='Zip' value='"+zip+"' oninput='checkZipCode()' /><p id='zipError'></p></td></tr>";
		html+="<tr> <td>Phone:</td><td><input id='txtPhoneNumber' type='text' name='Phone' oninput='phonenumber()' value='"+phone+"'/><p id='phoneError'></p></td></tr>";
		...
		html+="<tr> <td>Age:</td><td><input id='txtAge' type='text' name='Age' value='"+age+"' oninput='checkAge()'/><p id='ageFactor'></p></td></tr>";
		...
		html+="<td><textarea id='TextArea1' style=\"width:90%; display: block;margin-left: auto;margin-right: auto;\" name='Story' rows='3' cols='60' value='"+textAreaa+"'></textarea></td></tr>";
		...
		html+= "<input type='radio' name='chkPayment' value='yes'>Yes";
		 ...
		 html+= "<tr> <td>Veterinarian:</td><td><input id='txtAccNumber' type='text' name='Veterinarian' value='"+Veterinarian+"' /></td></tr>";
         html+="<tr> <td>Clinic Name:</td><td><input id='txtClinicName' type='text' name='Clinic Name' value='"+clinic_name+"' /></td></tr>";
         html+="<tr> <td>Phone</td><td><input id='txtPhoneNumber1' type='text' oninput='phonenumber2()' name='Phone Number' value='"+ph_number+"' /><p id='phoneError2'></p></td></tr>";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
	  ...
	  {
		  response.setContentType("text/html");
		  String html="<html><head><title>Part6</title></head><body>";
		  PrintWriter out = response.getWriter();
